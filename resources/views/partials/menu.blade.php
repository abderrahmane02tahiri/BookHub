<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('book_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/books*") ? "c-show" : "" }} {{ request()->is("admin/book-genres-and-categories*") ? "c-show" : "" }} {{ request()->is("admin/statuses*") ? "c-show" : "" }} {{ request()->is("admin/ratings*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('book_genres_and_category_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.book-genres-and-categories.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/book-genres-and-categories") || request()->is("admin/book-genres-and-categories/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-list-ul c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.bookGenresAndCategory.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('status_access')
                    ...
                    @can('income_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.incomes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/incomes") || request()->is("admin/incomes/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-arrow-circle-left c-sidebar-nav-icon">
