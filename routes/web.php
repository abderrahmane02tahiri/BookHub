...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::delete('book-genres-and-categories/destroy', 'BookGenresAndCategoriesController@massDestroy')->name('book-genres-and-categories.massDestroy');
    Route::resource('book-genres-and-categories', 'BookGenresAndCategoriesController');
