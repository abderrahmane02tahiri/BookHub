...
{
    private $models = [
        'TaskStatus'            => 'cruds.taskStatus.title',
        'TaskTag'               => 'cruds.taskTag.title',
        'Task'                  => 'cruds.task.title',
        'ExpenseCategory'       => 'cruds.expenseCategory.title',
        'IncomeCategory'        => 'cruds.incomeCategory.title',
        'Expense'               => 'cruds.expense.title',
        'Income'                => 'cruds.income.title',
        'TimeWorkType'          => 'cruds.timeWorkType.title',
        'TimeProject'           => 'cruds.timeProject.title',
        'TimeEntry'             => 'cruds.timeEntry.title',
        'Book'                  => 'cruds.book.title',
        'BookGenresAndCategory' => 'cruds.bookGenresAndCategory.title',
        'Status'                => 'cruds.status.title',
        'Rating'                => 'cruds.rating.title',
    ];
